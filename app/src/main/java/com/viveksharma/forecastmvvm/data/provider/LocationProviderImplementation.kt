...
import com.viveksharma.forecastmvvm.internal.LocationPermissionNotGrantedException
import com.viveksharma.forecastmvvm.internal.asDeferred
...
class LocationProviderImplementation(
    ...
    private fun hasLocationPermission(): Boolean {
        return ContextCompat.checkSelfPermission(
            appContext, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED
    }
